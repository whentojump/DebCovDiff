...
# .sho built from the same .c, but only after %.o exists
# (order-only prereq: the bar '|' enforces order without a rebuild dependency)
$(OBJS:%.o=%.sho) bzip2.sho bzip2recover.sho: %.sho: %.c | %.o
